    ...
    pageNumbers.push(
      <button
        ...
        className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ${
          currentPage === 1 ? 'bg-blue-900 text-white' : 'text-gray-900'
  ...
  for (let i = startPage; i <= endPage; i++) {
    pageNumbers.push(
      <button
        ...
        className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ${
          currentPage === i ? 'bg-blue-900 text-white' : 'text-gray-900'
        } ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0`}
      >
        {i}
      </button>
  ...
  if (endPage < totalPages) {
    ...
    pageNumbers.push(
      <button
        ...
        className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ${
          currentPage === totalPages ? 'bg-blue-900 text-white' : 'text-gray-900'
        } ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0`}
      >
        {totalPages}
      </button>
