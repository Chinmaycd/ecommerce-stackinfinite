...
//     const fetchData = async () => {
//       try {
//         let url = `http://192.168.1.12:8001/api/products/${productdesc}`;
//         const response = await axios.get(url);
//         setProd(response.data); // Assuming response.data contains the product details
//       } catch (error) {
//         console.log("Error fetching product:", error);
...
//                       height={200}
//                       width={200}
//                       src={prod.images[0]} // Assuming images is an array and you want to show the first image
//                       alt={prod.name}
...
//                   {prod.name}
//                 </h2>
//                 <p>{prod.description}</p> {/* Replace with actual description field */}
...
//                 <div className="flex flex-wrap gap-4 mt-8">
//                   <p className="text-gray-800 text-lg md:text-3xl font-bold">
//                     Rs. {prod.price} {/* Assuming price field */}
//                   </p>
//                 </div>
