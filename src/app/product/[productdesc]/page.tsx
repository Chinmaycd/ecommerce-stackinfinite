              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex flex-wrap gap-4 mt-8">
                  ...
                  {prod.outOfStock ? (
                    <button
                      type="button"
                      className="min-w-[200px] px-4 py-2.5 border border-gray-500 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded"
                      disabled
                    >
                      Out of stock
                    </button>
